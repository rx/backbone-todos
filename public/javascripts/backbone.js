...
(function(){
  ...
  _.extend(Backbone.Model.prototype, Backbone.Events, {
    ...
    // views need to be updated and/or what attributes need to be persisted to
    // the server.
  ...
  // Element lookup, scoped to DOM elements within the current views.
  ...
  _.extend(Backbone.View.prototype, Backbone.Events, {
    ...
    // For small amounts of DOM Elements, where a full-blown templates isn't
